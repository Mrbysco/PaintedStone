package juuxel.paintedstone.block;
...
public class BlockPaintedStone extends Block
{
    ...
    public BlockPaintedStone(float hardness, String name)
    {
        super(Material.rock);
    ...
    public BlockPaintedStone(float hardness, String name, Block dropBlock)
    {
        this(hardness, name);
